    ...
    <div className="card p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          {frontPreview ? (
            <div className="relative overflow-hidden rounded-lg border border-gray-200">
              <img src={frontPreview} alt="License front" className="h-40 w-full object-cover" />
              <button
            ...
            >
              <ImageIcon size={24} />
              <span className="mt-2 text-xs">Upload Front</span>
            </button>
          )}
          <input
            ref={frontRef}
        ...
        <div>
          ...
          {backPreview ? (
            <div className="relative overflow-hidden rounded-lg border border-gray-200">
              <img src={backPreview} alt="License back" className="h-40 w-full object-cover" />
              <button
            ...
            >
              <ImageIcon size={24} />
              <span className="mt-2 text-xs">Upload Back</span>
            </button>
          )}
          <input
            ref={backRef}
